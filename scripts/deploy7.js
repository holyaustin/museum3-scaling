...
const main = async () => {
  console.log("About to deploy contract Egypt on Morph;");
  ...
  console.log("About to deploy contract Egypt Minter on Morph: ");
  ...
  fs.writeFileSync('./configmorphegypt.js', `
  export const egyptAddressmorph = "${contract.address}" \n
  export const minterEgyptAddressmorph = "${contract2.address}"
`);
}
