        ...
        <div className="hidden md:flex justify-center w-full">
          <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
            ...
            <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
              ...
              <h2 className="focus:outline-none text-gray-400 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">
               Get Ready for some insane giveaways! There are going to multiple chances leading up to launch day where fans can enter for a chance to win custom one of kind merch, signed art, and their very own Galleria NFT. Don't forget about our member giveaway where we will select a winner to win from as many tour visitors !
              </h2>
            </div>
          ...
          <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
            ...
            <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
              <h1 className="focus:outline-none text-2xl tracking-wide font-semibold text-gray-200">
              Front-end Design / Developement
              </h1>
              <h2 className="focus:outline-none text-gray-400 mt-3 text-base leading-6 tracking-wide">
                For us, we know every great project needs a proper foundation. Our priority is to create an owner driven community that allows for you to receive the most return of investment for your unique NFT through a responsive user design and experience. As the community grows, the interaction wih the DApp would be seemless and introduction of more features to the pleasure of the community would be adhere to. The rule here is that after visiting this project, you would love to introduce friends and loved ones to also do same. we shall also be rewarding community members in the long run..
              </h2>
            </div>
            ...
            <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
              <h1 className="focus:outline-none text-2xl tracking-wide font-semibold text-gray-200">
                Project Launch Mainnet
              </h1>
              <h2 className="focus:outline-none text-gray-400 mt-3 text-base leading-6 tracking-wide">
                we are hoping that this project would be depoyed to mainnet in about 3 - months from now. The team would have teid the knot, dot every "i" and cross every "t". The project launch on mainnet will bring a whole new frontier in digital tourism where we can showcase African rich heritage through web3 tourism.
              </h2>
            </div>
          </div>
        </div>
